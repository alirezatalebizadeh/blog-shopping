...
export default function Navbar() {
  ...
  return (
    <>
      {/* Header for mobile */}
      <div className="flex items-center justify-between md:hidden text-zinc-700  dark:bg-zinc-700 px-5 h-16">
        <div
              ...
              <li>
                ...
                {isSubmenuOpen && (
                  <div className="submenu ml-5 mt-2 space-y-2">
                    <a href="#">Special Coffee</a>
                    <a href="#">World-Class Special</a>
                    <a href="#" className="submenu_item_active">
                      Premium Coffee
                    </a>
                    <a href="#">Commercial Blends</a>
                    <a href="#">Zino Brazilian Coffee</a>
